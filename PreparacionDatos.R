...
ac$TIPOVEHICULO <- as.character(ac$TIPOVEHICULO)
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Bicicleta EPAC (pedaleo asistido)'] <- 'Bici EPAC'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Maquinaria de obras'] <- 'Maquina Obras'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Microbús <= 17 plazas'] <- 'Microbus'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Motocicleta hasta 125cc'] <- 'Moto <125cc'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Motocicleta > 125cc'] <- 'Moto >125cc'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Otros vehículos con motor'] <- 'Otros con motor'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Otros vehículos sin motor'] <- 'Otros sin motor'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Vehículo articulado'] <- 'Articulado'
ac$TIPOVEHICULO[ac$TIPOVEHICULO == 'Autobús articulado'] <- 'Bus articulado'
ac$TIPOVEHICULO <- as.factor(ac$TIPOVEHICULO)
...
shp_madrid <-  st_read('C:/APPSHINY/ejercicio/data')
shp_mad <- shp_madrid[112:132,]

save(ac, shp_mad, shp_madrid, dataset, file="datospreparados.rda")